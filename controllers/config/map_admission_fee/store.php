...
if (!isset($_SESSION['username'])) {
    ...
    $a = mysqli_query($dbc,"SELECT * FROM classroom_admission_fee WHERE ClassroomId='$classroom_id'");
    ...
    if(mysqli_num_rows($a)>0){
        ...
        $stmt = $dbc->prepare("INSERT INTO classroom_admission_fee (ClassroomID, Amount, Username, Time) VALUES (?, ?, ?, ?)");
